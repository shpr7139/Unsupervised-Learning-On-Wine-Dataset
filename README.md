...
We apply **clustering algorithms** (KMeans, Agglomerative, Gaussian Mixture Models) and **dimensionality reduction** (PCA) to analyze the dataset, evaluate model performance, and interpret results.
